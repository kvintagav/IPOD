...
#define lcd44780_RCC					RCC_AHB1Periph_GPIOC
...
#define IR_RCC_PORT RCC_AHB1Periph_GPIOB
//gpio PB.3
...
#define UART_IPOD USART3
#define UART_IPOD_PORT GPIOC
#define UART_IPOD_TX GPIO_Pin_10
#define UART_IPOD_RX GPIO_Pin_11
#define UART_IPOD_RCC RCC_APB1Periph_USART3
#define UART_IPOD_RCC_GPIO   RCC_AHB1Periph_GPIOC       
#define UART_IPOD_TX_SOURCE GPIO_PinSource10
#define UART_IPOD_RX_SOURCE GPIO_PinSource11
#define UART_IPOD_AF GPIO_AF_USART3
#define UART_IPOD_IRQ USART3_IRQn
...
#define UART_EXT_RCC_GPIO          RCC_AHB1Periph_GPIOA
#define UART_EXT_RCC        RCC_APB1Periph_USART2
#define UART_EXT_IRQ USART2_IRQn
#define UART_EXT_TX_SOURCE GPIO_PinSource2
#define UART_EXT_RX_SOURCE GPIO_PinSource3
#define UART_EXT_AF GPIO_AF_USART2

/*LEDS*/
#define LD_GPIO_PORT 		GPIOB
#define LD_GREEN_GPIO_PIN 		GPIO_Pin_7
#define LD_BLUE_GPIO_PIN             GPIO_Pin_6
#define LD_GPIO_PORT_CLK             RCC_AHB1Periph_GPIOB


/*RELE*/
#define GPIO_RELE_RCC RCC_AHB1Periph_GPIOA
...
/*USB*/
#define GPIO_USB_RCC RCC_AHB1Periph_GPIOA
#define GPIO_USB GPIOA
#define PIN_USB1 GPIO_Pin_15
#define PIN_USB2 GPIO_Pin_12

/*IPOD DETECT*/
#define GPIO_ipod_RCC RCC_AHB1Periph_GPIOB
